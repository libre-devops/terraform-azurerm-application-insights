...
The smallest valid call: one component with the secure defaults (RBAC-only ingestion, 90 day
retention), embedded into a Log Analytics workspace (components are always workspace-based). The
